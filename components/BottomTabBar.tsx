...
export const BottomTabBar = ({ activeTab, onTabPress }: BottomTabBarProps) => {
  ...
  return (
    ...
    >
      {/* Home */}
      <Button className="flex-1 items-center justify-center h-full" activeOpacity={0.7} onPress={() => onTabPress('home')}>
      ...
      {/* Trips */}
      <Button className="flex-1 items-center justify-center h-full" activeOpacity={0.7} onPress={() => onTabPress('trips')}>
        <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
      ...
      {/* Explore */}
      <Button className="flex-1 items-center justify-center h-full" activeOpacity={0.7} onPress={() => onTabPress('explore')}>
        <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
      ...
      {/* Chat */}
      <Button className="flex-1 items-center justify-center h-full" activeOpacity={0.7} onPress={() => onTabPress('chat')}>
        <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
      ...
      {/* Profile */}
      <Button className="flex-1 items-center justify-center h-full" activeOpacity={0.7} onPress={() => onTabPress('profile')}>
        <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
