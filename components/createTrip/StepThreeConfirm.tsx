...
export const StepThreeConfirm = ({
  ...
  <View className="px-5 pb-10">
    ...
    <Text style={{ fontSize: 13, fontWeight: '700', color: '#111827', marginBottom: 8 }}>
      Địa điểm đã chọn ({selectedPlaceIds.length})
    </Text>
    {selectedPlaceSummaries.map((place) => (
      <View key={place.id} style={{ backgroundColor: 'white', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 10, padding: 10, marginBottom: 8 }}>
